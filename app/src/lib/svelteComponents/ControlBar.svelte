<script lang="ts">
	...
	import type { viewModeType } from '$lib/types/frontend';
	// Props
	interface Props {
...
<div class="control-bar">
	...
	{#if groupMode}
		<div class="group-controls">
			...
			<button class="add-to-group-btn" onclick={addToGroup} disabled={selectionCount === 0}>
				Add to Group
			</button>
			<button class="delete-btn" onclick={deleteSelected} disabled={selectionCount === 0}>
				Delete Selected
			</button>
		</div>
	{/if}
	...
	<div class="dropdown-controls">
		<DropDown label="Image Size" options={sizeOptions} bind:selectedValue={$improvImageSize} />
		<DropDown label="Image Count" options={countOptions} bind:selectedValue={$imageCount} />
	</div>
</div>
